...
- 2026-07-11 (v0.7.1): verified live on prod — sleep blocked 401ms, iterator fetched three notebooks into a table, api.github.com round trip 420ms with live star counts. Post-deploy verification used curl-based cache warming (see memory: prod cache-warming technique) because local Chromium's ERR_NETWORK_CHANGED kept cancelling in-flight cold compiles.
