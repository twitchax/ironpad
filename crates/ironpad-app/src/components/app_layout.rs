...
fn HeaderContent(ctx: LayoutContext) -> impl IntoView {
    ...
    view! {
        ...
        <div class="ironpad-header-right">
            ...
            // Compact: this sits in a 48px header, where the full-height
            // control the view-only toolbar uses reads as oversized.
            <div class="ironpad-theme-toggle ironpad-theme-toggle--compact">
                <button
